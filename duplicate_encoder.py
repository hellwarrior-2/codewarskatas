...
#test cases
print(duplicate_encode("din")) #should print "((("
print(duplicate_encode("recede")) #should print "()()()"
print(duplicate_encode("Success")) #should print ")())())"
print(duplicate_encode("(( @")) #should print "))(("