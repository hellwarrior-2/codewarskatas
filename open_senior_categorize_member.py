...
#form that will tell prospective members which category 
#they will be placed.
...
#Input
#Input will consist of a list of lists containing
#two items each. Each list contains information 
#for a single potential member. Information consists 
#of an integer for the person's age and an integer 
...
#(in Haskell: Open or Senior) stating whether the respective
...
#should return ['Open', 'Open', 'Senior', 'Open'])
